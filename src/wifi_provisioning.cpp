...
#ifndef WIFI_PROVISIONING_PREFERENCES_NAMESPACE
#define WIFI_PROVISIONING_PREFERENCES_NAMESPACE "wifi"
#endif

constexpr char kPreferencesNamespace[] = WIFI_PROVISIONING_PREFERENCES_NAMESPACE;
